...
import unittest
from python_project.test_case.public import login, public_module, check_data
import time
import openpyxl
...
class TestBusinessWhiteList(unittest.TestCase):
    ...
    #     try:
    #         wb = openpyxl.load_workbook(r"F:\\workplace\\GitWork\\python_project\\test_data\\查询条件.xlsx")
    #         sheet = wb["企业白名单1"]
    #         # rows = sheet.max_row
