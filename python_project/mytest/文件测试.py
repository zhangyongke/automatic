...
filepath1 = "F:\\workplace\\GitWork\\python_project\\test_data\\pi_digits.txt"
...
filename = '/python_project/test_data/pi_digits.txt'
...
# 在变量pi_string存储的字符串中，包含原来位于每行左边的空格，为删除这些空格，可使用strip()而不是 rstrip方法
...
filename = '/python_project/test_data\\pi_digits1.txt'
